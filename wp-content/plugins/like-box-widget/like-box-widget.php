...
class like_box_widget_facbook extends WP_Widget {
	...
	public function generete_facbook_widget_page($params){
		...
		$facbook_front.='<div style="font-size:2px;width:2px;height:1px;overflow: hidden;"><a href="https://wordpress.org/plugins/booking-calendar">WordPress booking</a></div>';
